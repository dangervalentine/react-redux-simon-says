 ...
 * author and linking to the source. Combines the homage ("Built by …")
 * with the action ("on GitHub") in one self-contained badge.
 *
 * Opens in a new tab; styled to be unobtrusive (low-contrast background,
 * smaller font) so it doesn't compete with the game. Stays visible on
 * mobile too — credit shouldn't be platform-conditional.
 *
 * Ported from react-connect4 so the two projects wear the same badge.
 */
const GithubAttribution = () => (
  ...
  >
    {/*
      ...
      a separate asset request. Path is the standard 16px Octicons mark
      simplified to the minimum required attributes.
    */}
    <svg
